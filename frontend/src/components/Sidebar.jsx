...
import LogoLUZ from '../static/images/logo-luz-white.svg'
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/" className="block">
            <img src={LogoLUZ} alt="Logo Luz" height="32" />
          </NavLink>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            <ul className="mt-3">
              ...
              {/* Analitico */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('analitico') && 'bg-slate-900'}`}>
                <NavLink end to="/analitico" className={`block text-slate-200 hover:text-white truncate transition duration-150 ${pathname.includes('analitico') && 'hover:text-slate-200'}`}>
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <path className={`fill-current text-slate-600 ${pathname.includes('analitico') && 'text-indigo-500'}`} d="M0 20h24v2H0z" />
                      <path className={`fill-current text-slate-400 ${pathname.includes('analitico') && 'text-indigo-300'}`} d="M4 18h2a1 1 0 001-1V8a1 1 0 00-1-1H4a1 1 0 00-1 1v9a1 1 0 001 1zM11 18h2a1 1 0 001-1V3a1 1 0 00-1-1h-2a1 1 0 00-1 1v14a1 1 0 001 1zM17 12v5a1 1 0 001 1h2a1 1 0 001-1v-5a1 1 0 00-1-1h-2a1 1 0 00-1 1z" />
                    </svg>
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Analítico</span>
                  </div>
                </NavLink>
              </li>
            </ul>
