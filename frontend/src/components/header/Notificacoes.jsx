            ...
            <li className="border-b border-slate-200 last:border-0">
              ...
              >
                <span className="block text-sm mb-2">
                  📣 <span className="font-medium text-slate-800">Lorem ipsum</span><br />
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                </span>
                <span className="block text-xs font-medium text-slate-400">12/06/2022</span>
              </Link>
            </li>
            <li className="border-b border-slate-200 last:border-0">
              <Link
              ...
              >
                ...
                <span className="block text-xs font-medium text-slate-400">11/06/2022</span>
              </Link>
            </li>
            <li className="border-b border-slate-200 last:border-0">
              <Link
              ...
              >
                <span className="block text-sm mb-2">
                  🚀<span className="font-medium text-slate-800">Ut eu odio</span><br />
                  Ut eu odio porta, malesuada elit vitae, bibendum libero.
                </span>
                <span className="block text-xs font-medium text-slate-400">10/06/2022</span>
              </Link>
            </li>
          </ul>
        </div>
