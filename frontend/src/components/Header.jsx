...
import Notifications from './header/Notificacoes';
import Ajuda from './header/Ajuda';
import PerfilUsuario from './header/PerfilUsuario';
...
function Header({
  ...
  const [searchModalOpen, setPesquisaOpen] = useState(false)
        ...
        <div className="flex items-center justify-between h-16 -mb-px">
          ...
          <div className="flex items-center">
            <button
              ...
              onClick={(e) => { e.stopPropagation(); setPesquisaOpen(true); }}
            ...
            <Pesquisa id="search-modal" searchId="search" modalOpen={searchModalOpen} setModalOpen={setPesquisaOpen} />
